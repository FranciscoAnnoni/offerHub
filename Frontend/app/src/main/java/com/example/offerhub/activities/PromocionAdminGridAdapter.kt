...
class PromocionAdminGridAdapter(private val context: Context, private var promociones: List<Promocion>, private var fragmentListener: PromocionFragmentListener) : BaseAdapter() {
...
// ...
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (elementoCache.containsKey(position)) {
         ...
         gridViewItem = inflater.inflate(R.layout.fragment_promocion_admin_card, null)
            ...
            if (userViewModel.logoComercios.containsKey(promocion.comercio)) {
                ...
                if (imgEnBase64 != null) {
                    ...
                    if(resizedBitmap!=null) {
                        resizedBitmap =
                            Bitmap.createScaledBitmap(resizedBitmap, width, height, false)
                        logo = resizedBitmap
